...
if st.session_state.count == 0:    
    wine = pd.read_csv('data/outresult_test4.csv', names=('name','source','AFC(1)/FS-AFC(2)','AFC(1)/Prop(2)','FS-AFC(1)/Prop(2)'))
    st.dataframe(wine)
    ...
    s_bool1 = ((data1['source'] == '鐘の音') & ((data1['AFC(1)/FS-AFC(2)'] == '2') or (data1['AFC(1)/FS-AFC(2)'] == 2)))
    s_bool2 = ((data1['source'] == '鐘の音') & ((data1['AFC(1)/Prop(2)'] == '2') or (data1['AFC(1)/Prop(2)'] == 2)))
    s_bool3 = ((data1['source'] == '鐘の音') & ((data1['FS-AFC(1)/Prop(2)'] == '2') or (data1['FS-AFC(1)/Prop(2)'] == 2)))
    ...
    s_bool1 = ((data1['source'] == 'ドアベル') & ((data1['AFC(1)/FS-AFC(2)'] == '2') or (data1['AFC(1)/FS-AFC(2)'] == 2)))
    s_bool2 = ((data1['source'] == 'ドアベル') & ((data1['AFC(1)/Prop(2)'] == '2') or (data1['AFC(1)/Prop(2)'] == 2)))
...
if st.session_state.count == -1:
    ...
    st.dataframe(df)
    df.to_csv('data/outresult_test4.csv', mode='a',header=False, index=False,encoding='utf_8_sig')
