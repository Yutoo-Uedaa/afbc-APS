...
if st.session_state.count == 0:    
    ...
    csv_financde = wine1.to_csv().encode('utf-8-sig').decode()
    st.download_button(
    label='CSVダウンロード',
    data=csv_financde,
    file_name='評価データ.csv',
...
if st.session_state.count == -35:
    ...
    sizi7.audio(audio_file_test_bytes, start_time=0)
    sel1 = st.empty()
    select1=sel1.radio('1-4.リファレンス音源に近い音源を選択してください。',('1','2'))
    if select1=='1':
        st.select1_4=str('2')
    else:
        st.select1_4=str('1') 
...
if st.session_state.count == -30:
    ...
    sizi7.audio(audio_file_test_bytes, start_time=0)
    sel1 = st.empty()
    select1=sel1.radio('2-3.リファレンス音源に近い音源を選択してください。',('1','2'))
    if select1=='1':
        st.select2_6=str('2')
    else:
        st.select2_6=str('1') 
...
if st.session_state.count == -25:
    ...
    sizi7.audio(audio_file_test_bytes, start_time=0)
    sel1 = st.empty()
    select1=sel1.radio('3-2.リファレンス音源に近い音源を選択してください。',('1','2'))
    if select1=='1':
        st.select3_3=str('2')
    else:
        st.select3_3=str('1') 
...
if st.session_state.count == -21:
    ...
    sizi7.audio(audio_file_test_bytes, start_time=0)
    sel1 = st.empty()
    select1=sel1.radio('3-6.リファレンス音源に近い音源を選択してください。',('1','2'))
    if select1=='1':
        st.select3_2=str('2')
    else:
        st.select3_2=str('1') 
...
if st.session_state.count == -19:
    ...
    sizi7.audio(audio_file_test_bytes, start_time=0)
    sel1 = st.empty()
    select1=sel1.radio('4-2.リファレンス音源に近い音源を選択してください。',('1','2'))
    if select1=='1':
        st.select4_5=str('2')
    else:
        st.select4_5=str('1') 
...
if st.session_state.count == -16:
    ...
    sizi7.audio(audio_file_test_bytes, start_time=0)
    sel1 = st.empty()
    select1=sel1.radio('4-5.リファレンス音源に近い音源を選択してください。',('1','2'))
    if select1=='1':
        st.select4_4=str('2')
    else:
        st.select4_4=str('1') 
...
if st.session_state.count == -5:
    ...
    sizi7.audio(audio_file_test_bytes, start_time=0)
    sel1 = st.empty()
    select1=sel1.radio('6-4.リファレンス音源に近い音源を選択してください。',('1','2'))
    if select1=='1':
        st.select6_3=str('2')
    else:
        st.select6_3=str('1')   
